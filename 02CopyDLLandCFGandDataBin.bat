...
copy Ogre\lib\x86\OgreMain.dll bin
copy Ogre\lib\x86\OgreOverlay.dll bin
copy Ogre\lib\x86\OgrePaging.dll bin
copy Ogre\lib\x86\OgreRTShaderSystem.dll bin
copy Ogre\lib\x86\OgreTerrain.dll bin
copy Ogre\lib\x86\OgreVolume.dll bin
copy Ogre\lib\x86\Plugin_BSPSceneManager.dll bin
copy Ogre\lib\x86\Plugin_CgProgramManager.dll bin
copy Ogre\lib\x86\Plugin_OctreeSceneManager.dll bin
copy Ogre\lib\x86\Plugin_OctreeZone.dll bin
copy Ogre\lib\x86\Plugin_ParticleFX.dll bin
copy Ogre\lib\x86\Plugin_PCZSceneManager.dll bin
...
REM copy CEGUI\lib\x86\CEGUICoreWindowRendererSet.dll bin
REM copy CEGUI\lib\x86\CEGUIExpatParser.dll bin
REM copy CEGUI\lib\x86\CEGUIOgreRenderer.dll bin
